          ...
          <div className="flex items-start gap-2">
            ...
            <div className="space-y-1">
              ...
              <div className="text-[11px] text-zinc-500 font-mono">
                Expression: <code className="text-zinc-300 bg-zinc-900 px-1 py-0.5 rounded select-text cursor-text">{scheduleExpr}</code>
              </div>
            </div>
          </div>
          <div className="flex justify-between border-t border-zinc-900/80 pt-2.5 font-mono text-[11px] text-zinc-400">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 font-mono text-xs">
            ...
            <div className="bg-zinc-950 p-3 rounded-xl border border-zinc-900 flex justify-between items-center">
              ...
              <span className="font-bold text-zinc-300">{failed}</span>
            </div>
          </div>
        </div>

        {/* Trigger Controls bar */}
        <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-3 flex gap-2">
          <button
            onClick={async () => {
